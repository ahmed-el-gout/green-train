...
function Section1() {
    return (
        <div className="container-fluid bg-white position-relative overflow-hidden ">
            <img className="img-fuild h-100 w-100 mx-1 mx-md-1 position-absolute" src={background2} alt="background" />
            <img className="img-fuild h-100 w-100 mx-2 mx-md-2 position-absolute" src={background1} alt="background" />
            <div className="container">
                <div className="row py-4">
                    <div className="col-12 col-md-6 d-flex flex-column justify-content-center text-center text-md-start  justify-content-md-center position-relative  col-lg-6 mb-3 my-md-auto my-lg-auto   pl-4   ">
                        ...
                        <button type="button" className="btn moredetails btn-primary my-4 mx-auto mx-md-0 px-0  ">Get More Details</button>
                    </div>
